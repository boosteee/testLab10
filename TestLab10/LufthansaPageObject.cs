...
namespace TestLab10
{
    public class LufthansaPageObject
    {
        ...
        private IWebElement _pointOfDestination => _driver.FindElement(By.CssSelector("#dcep-a10c1dd30-2a78-487a-9682-0065526a9424-flm-hotel-hotelQuery\\.cityName"));
        ...
        public LufthansaPageObject AvailableHotelsCheck(string city)
        {
            _acceptCookiesButton.Click();
            _hotelButton.Click();
            _pointOfDestination.Click();
            _pointOfDestination.SendKeys(city);
            _calendar.Click();
            _firstDay.Click();
            _lastDay.Click();
            _searchButton.Click();
